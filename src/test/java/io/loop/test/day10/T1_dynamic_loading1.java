...
public class T1_dynamic_loading1 {
    LoopPracticeDynamicLoading1 loopPracticeDynamicLoading1;//se crea el objeto
    ...
    public void dynamic_loading_1(){
        BrowserUtils.loopLinkClick("Dynamic Loading");//this works as link
        ...
        BrowserUtils.waitForInVisibility(loopPracticeDynamicLoading1.loadingBar,10);//it neeeds give time to the next testing step//loading bar to  disappear
